CLASS zcl_carga_biblioteca_carr DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
...
CLASS zcl_carga_biblioteca_carr IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_categ_ca,
          lt_catego    TYPE TABLE OF ztb_catego_carr,
          lt_clientes  TYPE TABLE OF ztb_clientes_car,
          lt_clnts_lib TYPE TABLE OF ztb_clnts_lib_ca,
          lt_libros    TYPE TABLE OF ztb_libros_carr.
...
******** ZTB_ACC_CATEG ********
    ...
    DELETE FROM ztb_acc_categ_ca.
    INSERT ztb_acc_categ_ca FROM TABLE @lt_acc_categ.
...
******** ZTB_CATEGO ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_carr.
    INSERT ztb_catego_carr FROM TABLE @lt_catego.
...
******** ZTB_CATEGO ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clientes_car.
    INSERT ztb_clientes_car FROM TABLE @lt_clientes.
...
******** ZTB_CLNTS_LIB ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clnts_lib_ca.
    INSERT ztb_clnts_lib_ca FROM TABLE @lt_clnts_lib.
...
******** ZTB_LIBROS ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libros_carr.
    INSERT ztb_libros_carr FROM TABLE @lt_libros.
